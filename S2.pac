...
function FindProxyForURL(url, host) {
    try {
        ...
        if (isLobbyLikeMode(mode)) {
            ...
            var lobbyProxy = getStableProxyFromPool(CONFIG.LOBBY_POOL, true);
            var lobbyChain = buildFailoverChain(lobbyProxy, CONFIG.LOBBY_POOL);
        ...
        var fallbackProxy = getStableProxyFromPool(CONFIG.LOBBY_POOL, false);
