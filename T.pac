...
// ║  Ranges: 10 | Amman: 7 | Match: 4 | Lobby: 3 | Voice: 3                        ║
// ╚══════════════════════════════════════════════════════════════════════════════╝

// ═══ MATCH PROXIES ═══
var MATCH_PROXIES = [
  { id: "M1", proxy: "PROXY 46.185.131.218:20001", city: "عمّان-مركز", tier: 1, priority: 1, alive: true, latency: 1, lastCheck: 0, failStreak: 0 },
  { id: "M2", proxy: "PROXY 46.185.131.219:20001", city: "عمّان-مركز", tier: 1, priority: 2, alive: true, latency: 1, lastCheck: 0, failStreak: 0 },
  { id: "M3", proxy: "PROXY 176.29.153.95:20001", city: "عمّان-غرب", tier: 1, priority: 3, alive: true, latency: 2, lastCheck: 0, failStreak: 0 },
  { id: "M4", proxy: "PROXY 212.35.66.45:20001", city: "عمّان-شرق", tier: 1, priority: 4, alive: true, latency: 2, lastCheck: 0, failStreak: 0 }
];

// ═══ LOBBY PROXIES ═══
var LOBBY_POOL = [
  { id: "L1", proxy: "PROXY 212.35.66.45:8085", weight: 8, score: 100, alive: true, city: "عمّان", consecutiveFails: 0 },
  { id: "L2", proxy: "PROXY 176.29.153.95:9030", weight: 7, score: 100, alive: true, city: "عمّان", consecutiveFails: 0 },
  { id: "L3", proxy: "PROXY 46.185.131.218:20002", weight: 6, score: 100, alive: true, city: "عمّان", consecutiveFails: 0 }
];

// ═══ SOCIAL PROXIES ═══
var SOCIAL_POOL = [
  { id: "S1", proxy: "PROXY 212.35.66.45:8086", alive: true, score: 100, type: "voice", city: "عمّان" },
  { id: "S2", proxy: "PROXY 176.29.153.95:9031", alive: true, score: 100, type: "voice", city: "عمّان" },
  { id: "S3", proxy: "PROXY 46.185.131.220:20003", alive: true, score: 100, type: "voice", city: "عمّان" }
];

// ═══ SPECTATE PROXIES ═══
var SPECTATE_POOL = [
  { id: "SP1", proxy: "PROXY 176.29.153.95:20004", alive: true, score: 100 },
  { id: "SP2", proxy: "PROXY 212.35.66.45:20004", alive: true, score: 100 },
  { id: "SP3", proxy: "PROXY 46.185.131.218:20004", alive: true, score: 100 }
];

var BLOCK  = "PROXY 127.0.0.1:9";
var DIRECT = "DIRECT";

// ═══ JORDAN IPv4 — 10 ranges (Custom Selection) ═══
var JORDAN_IPV4 = [
  ["94.249.0.0", "255.255.0.0"],  // Zain — Zain عقدة عمّان
  ["176.29.0.0", "255.255.0.0"],  // Orange — Orange عقدة عمّان
  ...
  ["213.139.192.0", "255.255.192.0"],  // Orange — Orange Business عمّان
  ["85.113.64.0", "255.255.192.0"],  // Orange — Orange LTE عمّان
  ["217.18.224.0", "255.255.224.0"],  // Orange — Orange Core عمّان
  ["213.139.128.0", "255.255.192.0"],  // Orange — Orange عمّان Extended
  ["94.249.0.0", "255.255.128.0"]  // Zain — Zain HQ عمّان
];

// ═══ AMMAN-SPECIFIC — 7 ranges ═══
var AMMAN_IPV4 = [
...
var ISP_FINGERPRINTS = {
  ...
  "jtg":     { asn: 8697,  matchProxy: 3, lobbyWeight: 6 },
  "batelco": { asn: 42932, matchProxy: 3, lobbyWeight: 5 }
};
