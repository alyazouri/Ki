...
function expandIPv6(address) {
  ...
  // إزالة الأقواس المربعة إن وُجدت
  if (address.charAt(0) === "[") {
  ...
  // معالجة IPv4-mapped IPv6 (مثل ::ffff:192.168.1.1)
...
// ———————————————————————
// كل قيمة لازم تكون بالـ expanded format (4 أحرف لكل hextet)
// حتى تتطابق مع الناتج من expandIPv6
var JO_IPV6_FIRST2 = [
  "2a00:18d0",  // Orange Jordan
  "2a01:01d0",  // Orange Jordan
  "2a01:ee40",  // Umniah
  "2a02:f0c0",  // Umniah
  "2a03:6d00",  // Zain Jordan
  "2a02:25d8",  // Jordan ISP
  "2a00:18d8",  // Orange Jordan
  "2001:32c0",  // Jordan Telecom
  "2a00:4620",  // Jordan ISP
  "2a02:5b60",  // Jordan ISP
  "2a03:6b00",  // Jordan ISP
  "2a02:c040",  // Jordan ISP
  "2a00:caa0",  // Jordan ISP
  "2a01:e240",  // Jordan ISP
  "2a00:76e0",  // Jordan ISP
  "2a00:b860",  // Jordan ISP
  "2a01:9700",  // Jordan ISP
  "2a02:2558",  // Jordan ISP
  "2a02:e680",  // Jordan ISP
  "2a02:09c0"   // Jordan ISP
];

// ننشئ نسخة مُعيّرة (normalized) من القائمة لتتطابق مع expandIPv6
var JO_IPV6_FIRST2_NORM = [];
(function() {
  for (var i = 0; i < JO_IPV6_FIRST2.length; i++) {
    var raw = JO_IPV6_FIRST2[i];
    // نعمل expand لكل hextet حتى 4 أحرف
    var parts = raw.split(":");
    var norm = "";
...
// ———————————————————————
// JORDAN IPv4 RANGES (كل النطاقات شغالة)
// ———————————————————————
var JO_IPV4_RANGES = [
  // ——— Umniah / AS9038 ———
  ["91.186.224.0",  19],
