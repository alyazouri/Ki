// ╔══════════════════════════════════════════════════════════════════════╗
// ║  PUBG Mobile — Jordan Local-Only PAC Script v9.2                   ║
// ║  Strict Jordan-focused routing                                      ║
// ║                                                                      ║
// ║  Policy:                                                             ║
// ║   • PUBG traffic: Jordan only                                        ║
// ║   • Non-Jordan PUBG endpoints: BLOCK                                 ║
// ║   • IPv6 Jordan detection: first 2 hextets only                      ║
// ║   • Match traffic prefers PROXY2                                     ║
// ║   • Lobby traffic prefers PROXY                                      ║
// ║   • Anti-cheat stays DIRECT                                          ║
// ║   • CDN / telemetry stays DIRECT                                     ║
// ╚══════════════════════════════════════════════════════════════════════╝
...
// ———————————————————————
// JORDAN IPv6 — FIRST TWO HEXTETS ONLY
// ———————————————————————
var JO_IPV6_FIRST2 = [
“2a00:18d0”,
“2a01:01d0”,
...
if (first2 === JO_IPV6_FIRST2[i]) return true;
}
return false;
}
// ———————————————————————
...
// Zain Jordan
[“176.29.0.0”, 16],
// شبكات أردنية/محلية جيدة لكن أقل أولوية من الثلاثة الكبار
[“82.212.64.0”, 18],
[“188.123.160.0”, 19],
[“81.28.112.0”, 20],
[“185.175.248.0”, 22],
...
[“93.93.144.0”, 21],
[“93.95.200.0”, 21],
// ظهرت كشبكة غير أردنية / أقل ملاءمة
[“46.248.192.0”, 19],
[“95.172.192.0”, 19],
[“109.107.224.0”, 19],
[“37.220.112.0”, 20],
...
function routeJordanPriorityPUBG(url, host) {
  ...
  // يجب وجود عنوان واحد على الأقل
  if (!ipv4 && !ipv6) return BLOCK;

  // إسقاط العناوين المحجوزة/الداخلية
  if (ipv4 && isBlockedIPv4(ipv4)) ipv4 = null;
  if (ipv6 && isBlockedIPv6(ipv6)) ipv6 = null;
  if (!ipv4 && !ipv6) return BLOCK;

  // يكفي أن يكون أحد العنوانين أردنياً لتمرير الاتصال
  var isJordan = (ipv4 && isJordanIPv4(ipv4)) || (ipv6 && isJordanIPv6(ipv6));
